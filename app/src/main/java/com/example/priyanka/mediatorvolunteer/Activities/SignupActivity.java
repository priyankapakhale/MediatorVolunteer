...
public class SignupActivity extends AppCompatActivity {
    ...
    public void createVolunteer(final Volunteer v)
    {

        ApiInterface apiService = ApiClient.getStringClient().create(ApiInterface.class);
        Call <ResponseBody> call = apiService.addUser(v.getName(),v.getContactNo(), v.getAddress(),v.getArea(),v.getEmailId(),v.getPassword());
    ...
    public void authenticate(Volunteer v)
    {
